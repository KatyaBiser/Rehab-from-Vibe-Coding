...
\textbf{SPLNĚNO} -- V grid layoutu terapeutů (style.css řádky 1189--1199) karty na pozicích \texttt{:nth-child(6n+1)} a \texttt{:nth-child(6n)} zabírají 2 sloupce pomocí \texttt{grid-column: span 2}, vytvářející zigzag pattern. Footer grid používá spanning přes více sloupců na různých breakpointech (jeden sloupec na mobilu, dva na tabletu, čtyři na desktopu).
