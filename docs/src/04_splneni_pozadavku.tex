...
\hline
Seznam terapeutů & \checkmark & Figma prototyp (výpis terapeutů) \\
\hline
Detail terapeuta & \checkmark & Figma prototyp (9 detailních profilů) \\
\hline
Vyhledávání & \checkmark & search-results.html (funkční stránka výsledků vyhledávání) \\
\hline
Kontakt & \checkmark & Email + telefon v patičce \\
\hline
Rezervace & \checkmark & Figma prototyp (kompletní rezervační flow) \\
\hline
