...
Kromě základních požadavků projekt obsahuje pokročilé selektory (\texttt{:first-child}, \texttt{:nth-child()}, \texttt{:not()}, adjacent sibling), transitions (0.3s ease) pro hover a focus stavy, breadcrumb navigaci na všech detailních stránkách, search dropdown s animacemi, hamburger menu s interaktivní navigací a optimalizované obrázky pomocí TinyPNG.
