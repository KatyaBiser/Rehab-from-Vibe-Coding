...
\hline
Web dává smysl & \checkmark & 9 stránek s konzistentním obsahem \\
\hline
...
\hline
Seznam terapeutů & \checkmark & pages/therapists/list.html (8 terapeutů v grid) \\
\hline
Detail terapeuta & \checkmark & 8 detailních profilů \\
\hline
...
% TODO: Přidat screenshot ukázky AI generovaného obsahu - profil terapeuta
% TODO: Přidat screenshot označení studentského projektu v patičce
...
Použity pokročilé CSS selektory (\texttt{:first-child, :last-child, :nth-child(), :not()}, adjacent sibling, direct child), CSS transitions (0.3s) a print styles.
...
% TODO: Přidat screenshot sémantických elementů v HTML - inspect element view
% TODO: Přidat screenshot CSS Grid layoutu - DevTools grid overlay
% TODO: Přidat screenshot WCAG accessibility audit výsledků (WAVE nebo Lighthouse)
