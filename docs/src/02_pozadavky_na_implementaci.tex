...
HTML5 byl vybrán pro bohatou sadu sémantických elementů zlepšujících strukturu, SEO a accessibility, nativní podporu multimédií a formulářů, a širokou podporu v moderních prohlížečích. CSS3 bez frameworků umožňuje moderní layoutové systémy (Grid, Flexbox) s čistou implementací, CSS variables pro snadnou správu designu, nativní transitions a animations a media queries pro responzivní design. Použití čistých technologií prokazuje fundamentální znalosti a je konceptuálně konzistentní s tématem projektu (web o rehabilitaci od AI závislosti ironicky používá základní webové standardy). Tento přístup přináší rychlejší načítání, vynikající výkon a plnou kontrolu nad chováním. Je součástí satirické zprávy projektu kritizující přílišnou závislost na frameworkech a nástrojích.
